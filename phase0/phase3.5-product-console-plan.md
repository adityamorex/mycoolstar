...
- **Invoice PDF: PARTIALLY SOLVED.** Every transaction carries a `public_url` (`app.saleson.co.in/c/5249/t/{public_id}`) — a shareable invoice link usable on the order screen. Whether it renders a true downloadable PDF needs one visual check.
